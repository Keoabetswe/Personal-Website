...
<body>
	...
	<section id="page">
		<ul class="accordion">
			<li>
				<button class="accordion-control">Background</button>
				<div class="accordion-panel">
					<p id="accordion-text">Software developer with a passion for programming, possessing skills in web and android apps.</p>
